...
urlpatterns = [
    ...
    path('service/<int:pk>/edit/', views.product_edit, name='product_edit'),
    path('customer/<int:pk>/delete/', views.service_delete, name='service_delete'),
    path('customer/<int:pk>/delete/', views.product_delete, name='product_delete'),
